...
<button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModal{{$j->id}}">
  Hapus
</button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-danger" href="{{url('admin/jabatan/delete/'.$j->id)}}">Hapus</a>
      </div>
    </div>
  </div>
</div>
